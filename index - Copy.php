            ...
            <div class="col-lg-10">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $arr = array();
                        $arr['provision-api'] = 'https://provision-api.dev.energia.gitops.vodafone.com/api/provision/actuator/info';
                        $arr['shopping cart checkout'] = 'https://shoppingcartcheckout-api.dev.energia.gitops.vodafone.com/api/shoppingcart-checkout/actuator/info';
					  $arr['si-authorization'] = 'https://si-authorization-api.dev.energia.gitops.vodafone.com/api/si-authorization/actuator/info';
					  $arr['ui-backend'] = 'https://ui-backend-api.dev.energia.gitops.vodafone.com/api/ui-backend/actuator/info';
					  $arr['si-user-token'] = 'https://si-user-token-api.dev.energia.gitops.vodafone.com/api/si-user-token/actuator/info';
					   $arr['biztalk-tmf-api'] = 'https://biztalk-tmf-api.dev.energia.gitops.vodafone.com/api/biztalk-tmf-api/actuator/info';
					   						    $arr['dsales-be'] = 'https://dsales-be-api.dev.energia.gitops.vodafone.com/api/order-create-service/actuator/info';
														  $arr['payment-methods-api'] = 'https://payment-methods-api.dev.energia.gitops.vodafone.com/api/paymentMethods/v1/actuator/info';
 ...
 <h2 class="my-4">UI Applications</h2>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        //echo json_encode($json);
                        $arr = array();
                        $arr['Selfcare UI'] = 'https://selfcare-ui.dev.energia.gitops.vodafone.com/'; 
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
						...
						$arr['payment-methods-api'] = 'https://payment-methods-api.dev.energia.gitops.vodafone.com/api/paymentMethods/v1/actuator/info';
						$arr['Product Catalog'] = 'https://dpim-api.dev.energia.gitops.vodafone.com/api/productInventoryManagement/v4/actuator/info';
