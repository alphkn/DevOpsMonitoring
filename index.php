                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $arrP["order-create-service"] =
                            "https://order-create-service-api.energia.vodafone.es/api/order-create-service/actuator/info";
                        ...
                        $arrP["northbound"] =
                            "https://northbound-api.energia.vodafone.es/api/northbound/actuator/info";
                        $url = "";
                        $i = 1;
...
<h2 class="my-4">R&D Microservices PROD</h2>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        ...
                        //echo json_encode($json);
						$arr = array();
						$arr['Account Management'] = 'https://dacm-api.energia.gitops.vodafone.com/api/accountManagement/v4/actuator/info';
						$arr['aggregate-api'] =  'https://aggregate-api.energia.gitops.vodafone.com/api/aggregate/v1/actuator/info';
						$arr['Agreement Management'] = 'https://dagm-api.energia.gitops.vodafone.com/api/agreementManagement/v4/actuator/info';
						$arr['backoffice-api'] = 'https://backoffice-api.energia.gitops.vodafone.com/api/backofficeTaskManagement/v4/actuator/info';
						$arr['Customer Management'] = 'https://dcm-api.energia.gitops.vodafone.com/api/customerManagement/v4/actuator/info';
						$arr['Document Management'] = 'https://ddms-api.energia.gitops.vodafone.com/api/documentManagement/v4/actuator/info';
						$arr['Geographic Address  Management'] = 'https://dgeo-api.energia.gitops.vodafone.com/api/geographicAddressManagement/v4/actuator/info';
						$arr['Partnership Management'] = 'https://dpm-api.energia.gitops.vodafone.com/api/partnershipManagement/v4/actuator/info';
						$arr['Party Management'] = 'https://dpam-api.energia.gitops.vodafone.com/api/partyManagement/v4/actuator/info';
						$arr['Party Role Management'] = 'https://dpr-api.energia.gitops.vodafone.com/api/partyRoleManagement/v4/actuator/info';
						$arr['Product Catalog'] = 'https://dpc-api.energia.gitops.vodafone.com/api/productCatalogManagement/v4/actuator/info';
						$arr['Product Inventory Management'] = 'https://dpim-api.energia.gitops.vodafone.com/api/productInventoryManagement/v4/actuator/info'; 
						$arr['Product Ordering Management'] = 'https://dpom-api.energia.gitops.vodafone.com/api/productOrderingManagement/v4/actuator/info';
						$arr['Reference Management'] = 'https://reference-management-api.energia.gitops.vodafone.com/api/referenceManagement/v4/actuator/info';
						$arr['Resource Inventory Management'] = 'https://dri-api.energia.gitops.vodafone.com/api/resourceInventoryManagement/v4/actuator/info'; 
						$arr['Resource Catalog Management'] = 'https://drc-api.energia.gitops.vodafone.com/api/resourceCatalogManagement/v4/actuator/info';
						$arr['Resource Ordering Management'] = 'https://dro-api.energia.gitops.vodafone.com/api/resourceOrderingManagement/v4/actuator/info';
						$arr['Resource Order Fulfillment'] = 'https://drof-api.energia.gitops.vodafone.com/api/resourceOrderFulfillment/v4/actuator/info';
						$arr['S3'] = 'https://s3-api.energia.gitops.vodafone.com/api/storageService/v4/actuator/info';
						$arr['Service Catalog Management'] = 'https://dsc-api.energia.gitops.vodafone.com/api/serviceCatalogManagement/v4/actuator/info';
						$arr['Service Ordering Management'] = 'https://dso-api.energia.gitops.vodafone.com/api/serviceOrderingManagement/v4/actuator/info';
						$arr['Service Inventory Management'] = 'https://dsi-api.energia.gitops.vodafone.com/api/serviceInventoryManagement/v4/actuator/info';
						$arr['Service Ordering Fulfillment'] = 'https://dsof-api.energia.gitops.vodafone.com/api/serviceOrderFulfillment/v4/actuator/info';
